...
using EcoPowerLMS.Models;
using Microsoft.AspNetCore.Authorization;

namespace EcoPowerLMS.Controllers
{
    [Authorize]
    ...
    {
        private readonly EcoPowerSolutionContext _context;

        public OrderDetailsController(EcoPowerSolutionContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<OrderDetail>> PostOrderDetail(OrderDetail orderDetail)
        {
          if (_context.OrderDetails == null)
          {
              return Problem("Entity set 'EcoPowerSolutionContext.OrderDetails'  is null.");
          }
